...
<asp:Content ID="Main" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h3>Drużyny</h3>
    <asp:GridView ID="TeamGridView" runat="server" AutoGenerateColumns="true" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" AutoGenerateSelectButton="True" OnSelectedIndexChanged="TeamDataGrid_SelectedIndexChanged" OnRowEditing="TeamGridView_RowEditing"/>
    <h3>Stacje</h3>
